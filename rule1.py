...
if __name__ == "__main__":
    ...
    rule1 = "iptables -t nat -A PREROUTING -p tcp --dport 8888 -j REDIRECT --to-ports 5000" # redirect the port
    rule2 = "iptables -t nat -A OUTPUT -d localhost -p tcp --dport 8888 -j REDIRECT --to-ports 5000" # reject the visit of 888 port with the hello world html
    rules = rule1
    os.system(rules)
